...
function create_database() {
    ...
    mysql -u root -e "CREATE DATABASE qipr CHARACTER SET utf8"
}
...
function apache_setup() {
    ...
    ln -sfv /vagrant/apache.conf /etc/apache2/sites-available/qipr.conf
    ln -sfv /vagrant/apache.conf /etc/apache2/sites-enabled/qipr.conf
